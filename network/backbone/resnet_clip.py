...
class ModifiedResNet(nn.Module):
    ...
    def forward(self, x, trunc0= False, trunc1 = False, trunc2 = False, trunc3=False,trunc4=False, get0=False, get1=False, get2=False,get3=False, get4=False,get_z=False):
        def stem(x):
        ...
        if not trunc0 and not trunc1 and not trunc2 and not trunc3 and not trunc4:
...
def build_model(state_dict: dict,replace_stride_with_dilation=[False,False,True]):
    ...
    vision_layers = tuple(counts)   # [3, 4, 6, 3]
    ...
    image_resolution = output_width * 32    # 224
